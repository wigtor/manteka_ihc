		...
		<div class="span6">
				<div class="control-group">
					...
					<div class="controls">
						...
						<input id="rutEditar" onblur="comprobarRut()" type="text" maxlength="10" pattern="[0-9]+" title="Ingrese sólo números sin dígito verificador" min="1" name="rutEditar" placeholder="Ej:17785874" required>
					</div>
				</div>
				<div class="control-group">
