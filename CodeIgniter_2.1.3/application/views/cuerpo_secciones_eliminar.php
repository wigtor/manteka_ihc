...
<script type="text/javascript">
	...
	function eliminarSeccion(){
		if ($('#id_seccion').val().trim() == '') {
			...
			$('#textoErrorDialog').html('No ha seleccionado una sección para eliminar');
			$('#modalError').modal();
			return;
		}
		$('#tituloConfirmacionDialog').html('Confirmación para eliminar sección');
		$('#textoConfirmacionDialog').html('¿Está seguro que desea eliminar permanentemente la sección del sistema?');
...
<fieldset>
<legend>Eliminar Sección</legend>
	<div class= "row-fluid">
		<div class="span5">
	...
	<div class="row-fluid">
		...
		<div class="span7">
			<?php
				...
				echo form_open('Secciones/postEliminarSeccion/', $atributos);
			?>
...
Bloque horario:  <b id="modulo_horario"></b>
Día clase:       <b id="dia"></b>
Hora clase:      <b id="hora"></b></pre>
				...
				<div class="control-group">
					<div class="controls pull-right">
						<button type="button" class="btn" onclick="eliminarSeccion()">
