<script>
	...
	var url_post_busquedas = "<?php echo site_url("ActividAdesmasivas/getActividadsAjax") ?>";
	var url_post_historial = "<?php echo site_url("HistorialBusqueda/buscar/actividads") ?>";
	...
	function verDetalle(elemTabla) {
		...
		$.ajax({//AJAX PARA OBTENER LOS DETALLES DEL MÓDULO
			type: "POST",
			url: "<?php echo site_url("ActividAdesmasivas/getDetallesActividadAjax") ?>",
			...
			success: function(respuesta) { /* Esta es la función que se ejecuta cuando el resultado de la respuesta del servidor es satisfactorio */
				...
				$.ajax({//AJAX PARA SESIONES
					type: "POST",
					url: "<?php echo site_url("ActividAdesmasivas/getSesionesByModuloTematicoAjax") ?>",
				...
				$.ajax({//AJAX PARA EQUIPO y lider
					type: "POST",
					url: "<?php echo site_url("ActividAdesmasivas/getProfesoresByModuloTematicoAjax") ?>",
					data: { id_mod_post: codigo_modulo},
					success: function(respuesta) {
						//para equipo
				...
				$.ajax({//AJAX PARA implementos
					type: "POST",
					url: "<?php echo site_url("ActividAdesmasivas/getImplementosByModuloTematicoAjax") ?>",
					data: { id_mod_post: codigo_modulo},
					success: function(respuesta) {
...
<fieldset>
	...
	<div class="row-fluid">
		<div class="span6">
			1.- Seleccione un actividad masivo para ver sus detalles:
		</div>
		<div class="span6">
			2.- Detalle actividad masivo
		</div>
	</div>
	<div class="row-fluid" >
