		...
		<div  class="row-fluid">
			...
			<div class="span6">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="telefono" name="telefono" class="span12" maxlength="10" minlength="7" pattern="[0-9]{8}" title="Ingrese sólo números" placeholder="Ingrese solo numeros" >
					</div>
				</div>
				<div class="control-group">
