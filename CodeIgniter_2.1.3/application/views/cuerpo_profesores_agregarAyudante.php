			...
			<div class="row_fluid" style="margin-left:2%">
				<div class="span6">
					<div class="row">
							<div class="span4">
								<div class="control-group">
		  							<label class="control-label" for="inputInfo">1-.*Nombre</label>
		  						</div>
		  					</div>
		  					<div class="span5">	
		  							<div class="controls">
					...
					<div class="row">
							<div class="span4">
								<div class="control-group">
		  							<label class="control-label" for="inputInfo">4-.*RUT</label>
		  						</div>
		  					</div>
		  					<div class="span5">	
		  							<div class="controls">
				...
				<div class="span6">
					<div class="row">
							<div class="span5">
								<div class="control-group">
		  							<label class="control-label" for="inputInfo">6-.*Asignar Sección</label>
		  						</div>
							</div>
							<div  class="span6">
								<div class="controls">
