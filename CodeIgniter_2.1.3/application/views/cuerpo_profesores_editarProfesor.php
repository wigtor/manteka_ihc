					...
					<div class="span6">
						...
						<form id="FormEditar" type="post" onsubmit="EditarProfesor()">
							...
							<div class="row-fluid">
								...
								<div class="span5">	
									<div class="controls">
										<input type="text" pattern="[a-zA-ZñÑáéíóúüÁÉÍÓÚÑ\-_çÇ& ]+" title="Use solo letras para este campo" id="nombreProfeEdit1" name="nombre_1" required>
									</div>
								</div>
							</div>
														<div class="row-fluid">
								...
								<div class="span5">	
									<div class="controls">
										<input type="text" pattern="[a-zA-ZñÑáéíóúüÁÉÍÓÚÑ\-_çÇ& ]+" title="Use solo letras para este campo" id="nombreProfeEdit2" name="nombre_2" required>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								...
								<div class="span5">	
									<div class="controls">
										<input type="text" pattern="[a-zA-ZñÑáéíóúüÁÉÍÓÚÑ\-_çÇ& ]+" title="Use solo letras para este campo" id="apellidoPaternoProfeEdit" name="apellidoPaterno_profe" required>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								...
								<div class="span5">	
									<div class="controls">
										<input type="text" pattern="[a-zA-ZñÑáéíóúüÁÉÍÓÚÑ\-_çÇ& ]+" title="Use solo letras para este campo" id="apellidoMaternoProfeEdit" name="apellidoMaterno_profe" required>
									</div>
								</div>
							</div>
							<div class="row-fluid">
