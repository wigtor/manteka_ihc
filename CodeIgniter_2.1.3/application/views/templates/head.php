<head>
	...
	<link rel="stylesheet" href="/<?php echo config_item('dir_alias') ?>/css/non-responsive.css" type="text/css" media="all" />
	<link rel="stylesheet" href="/<?php echo config_item('dir_alias') ?>/css/ant-sig.css" type="text/css" media="all" />
	<link rel="stylesheet" href="/<?php echo config_item('dir_alias') ?>/css/personalizados_bootstrap3.css" type="text/css" media="all" />
	...
	<script src="/<?php echo config_item('dir_alias') ?>/javascripts/bootstrap.js"></script>
	<!--
	...
	$(document).ready(function() {
		$('.panel').css("box-shadow", "0px 1px 1px rgba(0, 0, 0, 0) inset, 0px 0px 8px rgba(0, 0, 0, 0)")
		$(".in").parents('.panel').css("box-shadow", "0px 1px 1px rgba(0, 0, 0, 0.075) inset, 0px 0px 8px rgba(82, 168, 236, 0.6)")

		$(".in").parents('.panel').css("border-radius", "4px")
		$(".in").parents('.panel').css("-moz-border-radius", "4px")
		$(".in").parents('.panel').css("-webkit-border-radius", "4px")
		$('.panel-heading').css("border-radius", "5px")
		$('.panel-heading').css("background-color", "rgb(255, 255, 255)")
		$(".in").parents('.panel').find('.panel-heading').css("background-color", "rgb(248, 248, 248)")
		$(function() { 
