		...
		<div class="span12" id="visualizar-coordinador">
			...
			<?php 
				foreach ($listado_coordinadores as $coordinador){
					...
					echo "<tr><td><h6><span class='text-error'>(*)</span>Contraseña :</h6></td><td><input name='contrasena' class ='input-xlarge'  type='text' placeholder='*******' default='".$coordinador['contrasena']."' value='".$coordinador['contrasena']."'></td></tr>";
					echo "<tr><td><h6><span class='text-error'>(*)</span>Reingresar contraseña:</h6></td><td><input name='contrasena2' class ='input-xlarge' type='text' placeholder='*******' default='".$coordinador['contrasena']."' value='".$coordinador['contrasena']."'></td></tr>";
					...
					echo "<tr><td><h6><span class='text-error'>(*)</span>Teléfono :</h6></td><td><input name='fono' class ='input-xlarge' type='text' placeholder='ej:9-87654321' default='".$coordinador['fono']."' value='".$coordinador['fono']."'></td></tr>";
